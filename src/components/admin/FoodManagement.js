...
<div> 
    ...
    <p className='text-center fs-2 fw-bold mt-3'>Add New Food Here</p>
    <Form>
    ...
    <Button variant="primary" onClick={()=>handleSubmit()}>
     ...
     <div className='container'>
        <p className='text-center fs-2 fw-bold mt-2'>List of Added Foods are here</p>
          ...
          data.map((e,i)=>{
            return <div className='card text-center m-3 shadow p-3 mb-5 bg-body rounded d-flex align-items-stretch' style={{ width: "18rem"}} key={i}>
              ...
              <div className='card-body'>
                ...
                <div className='mt-2'>
                  <Button onClick={()=>handleDelete(e._id)} variant='danger'>Delete</Button>
                </div>
              </div>
            </div>
          })
